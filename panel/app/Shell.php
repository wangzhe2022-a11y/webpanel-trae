        ...
        return match (true) {
            ...
            str_starts_with($script, 'wp-sys') && $a === 'disk-usage'
                => ['ok' => true, 'data' => [
                    ...
                    'total' => '18.4 GB',
                    'categories' => [
                        ['name' => 'Files in home directory', 'size' => '4.25 MB', 'icon' => 'home'],
                        ['name' => 'Files in hidden subdirectories', 'size' => '1.58 GB', 'icon' => 'hidden'],
                        ['name' => 'Databases', 'size' => '315.48 MB', 'icon' => 'database'],
                        ['name' => 'Mailing Lists', 'size' => '0 B', 'icon' => 'mailing'],
                        ['name' => 'Email', 'size' => '127.41 MB', 'icon' => 'email'],
                        ['name' => 'Website Files', 'size' => '3.16 GB', 'icon' => 'globe'],
                        ['name' => 'Logs', 'size' => '227.3 MB', 'icon' => 'doc'],
                        ['name' => 'Temporary Files', 'size' => '780.64 MB', 'icon' => 'clock'],
                        ['name' => 'Other', 'size' => '5.29 GB', 'icon' => 'dots'],
                    ],
                    'largest_dirs' => [
